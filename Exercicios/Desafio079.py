...
while True:
    ...
    # Se o input não estiver na lista, este será adicionado ao fim dela
    if n not in numeros:
        numeros.append(n)
    ...
    # Variável solicitante de continuação ou encerramento do programa
...
# Imprimindo o nosso separador(legibilidade no print)
print('-=' * 30)
